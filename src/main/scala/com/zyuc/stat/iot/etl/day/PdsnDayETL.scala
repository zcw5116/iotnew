...
object PdsnDayETL {
  def main(args: Array[String]): Unit = {
    ...
    val outputPath = sc.getConf.get("spark.app.outputPath","/user/iot_ete/data/cdr/summ_d/pdsn/")
    ...
    val mdnDF = sqlContext.sql(
      s"""
         |select  u.custid, u.custname, c.mdn, c.sid, cellid, b.provname as provid, nvl(b.cityname,'-') as lanid, c.bsid,
