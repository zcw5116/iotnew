...
/**
  ...
  */
object CdrBaseOnProvAnalysisDay {
  def main(args: Array[String]): Unit = {
    ...
    val outputPath = sc.getConf.get("spark.app.outputPath","/user/iot_ete/data/cdr/summ_d/baseOnProv/day/")
    ...
    try{
      ...
      sqlContext.read.format("orc").load(inputPathPdsn + "dayid=" + dayid).filter("service_option='59'")
      ...
      sqlContext.read.format("orc").load(inputPathPdsn + "dayid=" + dayid).filter("service_option='33'")
      ...
      insert2Tidb("iot_ana_prov_access_stat_cdma1x_day",outputPath + "Cdma1x/" + dayid)
