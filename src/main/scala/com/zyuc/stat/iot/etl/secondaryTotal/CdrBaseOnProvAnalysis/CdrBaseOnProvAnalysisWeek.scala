...
/**
  ...
  */
object CdrBaseOnProvAnalysisWeek {
  def main(args: Array[String]): Unit = {
    ...
    val outputPath = sc.getConf.get("spark.app.outputPath","/user/iot_ete/data/cdr/summ_d/baseOnProv/week/")
    ...
    try{
      ...
      sqlContext.read.format("orc").load(inputPathNB + "dayid=" + onedayago,
        inputPathNB + "dayid=" + twodayago, inputPathNB + "dayid=" + threedayago,
        inputPathNB + "dayid=" + fourdayago, inputPathNB + "dayid=" + fivedayago,
        inputPathNB + "dayid=" + sixdayago, inputPathNB + "dayid=" + sevendayago)
      ...
      insert2Tidb("iot_ana_prov_access_stat_nb_week",outputPath + "NB/" + dayid)
    ...
    try{
      ...
      sqlContext.read.format("orc").load(inputPathPgw + "dayid=" + onedayago,
        inputPathPgw + "dayid=" + twodayago, inputPathPgw + "dayid=" + threedayago,
        inputPathPgw + "dayid=" + fourdayago, inputPathPgw + "dayid=" + fivedayago,
        inputPathPgw + "dayid=" + sixdayago, inputPathPgw + "dayid=" + sevendayago).filter("rattype='6'")
      ...
      insert2Tidb("iot_ana_prov_access_stat_4g_week",outputPath + "4G/" + dayid)
    ...
    try{
      ...
      sqlContext.read.format("orc").load(inputPathPgw + "dayid=" + onedayago,
        inputPathPgw + "dayid=" + twodayago, inputPathPgw + "dayid=" + threedayago,
        inputPathPgw + "dayid=" + fourdayago, inputPathPgw + "dayid=" + fivedayago,
        inputPathPgw + "dayid=" + sixdayago, inputPathPgw + "dayid=" + sevendayago).filter("rattype='102'")
      ...
      insert2Tidb("iot_ana_prov_access_stat_ehrpd_week",outputPath + "Ehrpd/" + dayid)
    ...
    try{
      ...
      sqlContext.read.format("orc").load(inputPathPdsn + "dayid=" + onedayago,
        inputPathPdsn + "dayid=" + twodayago, inputPathPdsn + "dayid=" + threedayago,
        inputPathPdsn + "dayid=" + fourdayago, inputPathPdsn + "dayid=" + fivedayago,
        inputPathPdsn + "dayid=" + sixdayago, inputPathPdsn + "dayid=" + sevendayago).filter("service_option='59'")
      ...
      insert2Tidb("iot_ana_prov_access_stat_evdo_week",outputPath + "Evdo/" + dayid)
      ...
      sqlContext.read.format("orc").load(inputPathPdsn + "dayid=" + onedayago,
        inputPathPdsn + "dayid=" + twodayago, inputPathPdsn + "dayid=" + threedayago,
        inputPathPdsn + "dayid=" + fourdayago, inputPathPdsn + "dayid=" + fivedayago,
        inputPathPdsn + "dayid=" + sixdayago, inputPathPdsn + "dayid=" + sevendayago).filter("service_option='33'")
      ...
      insert2Tidb("iot_ana_prov_access_stat_cdma1x_week",outputPath + "Cdma1x/" + dayid)
    ...
    def insert2Tidb(tableBP:String, datapath:String) = {
      ...
      dbConn.close()
      ////////////////////
      CommonUtils.updateBreakTable(tableBP, dayid)
    }
