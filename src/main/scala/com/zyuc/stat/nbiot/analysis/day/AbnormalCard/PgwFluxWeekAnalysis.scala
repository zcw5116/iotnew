...
object PgwFluxWeekAnalysis {
  def main(args: Array[String]): Unit = {
    ...
    val outputPath = sc.getConf.get("spark.app.outputPath","/user/iot/data/cdr/abnormalCard/summ_w/pgw")
    ...
    sqlContext.read.format("orc").load(inputPath + "dayid=" + onedayago,
      ...
      .coalesce(70)
      .write.format("orc").mode(SaveMode.Overwrite).save(outputPath + "/" + d + "/base")
    ...
    val baseFluxDF = baseFlux.selectExpr("custid", "'4G' as netType", "'周' as anaCycle", s"'${d}' as summ_cycle",
