...
object PgwCdrDayTotal {
  def main(args: Array[String]): Unit = {
    ...
    val outputPath = sc.getConf.get("spark.app.outputPath","/user/iot/data/cdr/summ_d/jiangsuEPC/pgw/")
    ...
    val userDF = sqlContext.read.format("orc").load(userDataPath).filter("is4g='Y'").selectExpr("mdn","beloprov")
    ...
    CommonUtils.updateBreakTable("iot_ana_day_prov_stat_4g", dd)
