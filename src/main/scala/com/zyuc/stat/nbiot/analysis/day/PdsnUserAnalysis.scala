...
object PdsnUserAnalysis {
  def main(args: Array[String]): Unit = {
    ...
    val outputPath = sc.getConf.get("spark.app.outputPath","/user/iot/data/baseuser/summ_d/pdsn/")
    ...
    val deleteSQL =
      s"""
         |delete from iot_ana_3g_data_summ_d_$dayid where summ_cycle=? and meas_obj=?
       """.stripMargin
    ...
    val sql =
      s"""
         |insert into iot_ana_3g_data_summ_d_$dayid
    ...
    CommonUtils.updateBreakTable("iot_3g_base", dayid)
