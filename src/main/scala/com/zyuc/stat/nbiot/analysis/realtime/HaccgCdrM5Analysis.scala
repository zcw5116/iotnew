...
/**
  * Created by liuzk on 18-10-31 下午10:29.
  */
object HaccgCdrM5Analysis {
  def main(args: Array[String]): Unit = {
    ...
    val outputPath = sc.getConf.get("spark.app.outputPath", "/user/iot/data/cdr/analy_realtime/haccg")
    ...
    val haccgpath = inputPath + "/d=" + d + "/h=" + h + "/m5=" + m5

    val haccgM5DF = sqlContext.read.format("orc").load(haccgpath).filter("acct_status_type=2")
    val haccgM5Table = "spark_nbm5"
    haccgM5DF.registerTempTable(haccgM5Table)
    ...
    val sql =
      s"""
         |insert into iot_ana_5min_3g_cdr
