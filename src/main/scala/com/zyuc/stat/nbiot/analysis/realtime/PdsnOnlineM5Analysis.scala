...
object PdsnOnlineM5Analysis {
  def main(args: Array[String]): Unit = {
    ...
    val inputPath = sc.getConf.get("spark.app.inputPath", "/user/iot/data/online/transform/3g/data")
    val outputPath = sc.getConf.get("spark.app.outputPath", "/user/iot/data/online/analy_realtime/3g")
    ...
    // 更新断点时间
    CommonUtils.updateBreakTable("iot_ana_5min_3g_online", dataTime+"00")
