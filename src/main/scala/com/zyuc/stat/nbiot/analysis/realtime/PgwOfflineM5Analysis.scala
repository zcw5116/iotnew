...
/**
  * Created by liuzk on 18-7-10.
  */
object PgwOfflineM5Analysis {
  def main(args: Array[String]): Unit = {
    ...
    val inputPath = sc.getConf.get("spark.app.inputPath", "/user/iot/data/offline/transform/4g/data")
    val outputPath = sc.getConf.get("spark.app.outputPath", "/user/iot/data/offline/analy_realtime/4g")
    ...
    val sql =
      s"""
         |insert into iot_ana_5min_4g_offline
    ...
    // 更新断点时间
    CommonUtils.updateBreakTable("iot_ana_5min_4g_offline", dataTime+"00")
  }
}
