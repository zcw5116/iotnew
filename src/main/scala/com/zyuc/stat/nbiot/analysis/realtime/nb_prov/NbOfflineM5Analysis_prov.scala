...
object NbOfflineM5Analysis_prov {
  def main(args: Array[String]): Unit = {
    ...
    val appName = sc.getConf.get("spark.app.name","NbOfflineM5AnalysisProv_201808061732")
    val inputPath = sc.getConf.get("spark.app.inputPath", "/user/iot/data/offline_prov/transform/nb/data")
    val outputPath = sc.getConf.get("spark.app.outputPath", "/user/iot/data/offline_prov/analy_realtime/nb")
    ...
    val onlineDF = resultDF.selectExpr("gather_cycle","gather_date", "gather_time", "btsid", "province", "city","town","region","bts", "'ABOFFLINEUSERS' as gather_type", "num as gather_value")
    ...
    CommonUtils.updateBreakTable("iot_ana_5min_prov_nb_stat_offline", dataTime+"00")
